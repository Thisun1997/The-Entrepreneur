...
<html lang="en">
  ...
  <body>    
    ...
    <div class="column">
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form method="post" action="" class="login100-form validate-form">
          ...
          <?php include('errors.php'); echo"<br/>"?>
          <div id="new"></div>
          <div class="wrap-input100 validate-input" data-validate="Name is required">
            <span class="label-input100">First Name</span>
            <input class="input100" type="text" name="firstname" value="<?php echo $firstname; ?>">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
            <span class="label-input100">Last name</span>
            <input class="input100" type="text" name="lastname" value="<?php echo $lastname; ?>">
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="wrap-input100 validate-input" data-validate = "Password is required">
            ...
            <input class="input100" id="password-field1" type="password" name="password_1" >
            <span class="focus-input100"></span>
    ...
    <div class="column">
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form method="post" action="index.php#register-login" class="login100-form validate-form">
          <h2 class="tm-text-primary mb-4 tm-section-title">
            Login
          </h2>
          <?php include('errorslog.php'); echo"<br/>"?>
          <div class="wrap-input100 validate-input" data-validate="Name is required">
            <span class="label-input100">Email</span>
            <input class="input100" type="text" name="emaillog" value="<?php echo $email2; ?>">
            <span class="focus-input100"></span>
          </div>
