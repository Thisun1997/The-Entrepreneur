...
if(isset($_POST["email"]))
{
    ...
    $education = $_POST['education'];
		...
		$newvalues = implode(",",$category);
  			$query = "UPDATE inventor SET `phone-number` = '$phone',
                                       `address` = '$address',
...
.image:hover + .tooltiptext2 {
 ...
 <br /><br>
  <div class="container box">
   <br />
   <h2 style="color:white">Inventor account</h2><br />
   <?php echo $message; ?>
   <form method="post" id="register_form">
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <input type="text" name="phone" id="phone" class="form-control" value="<?php echo $userdata['phone-number']; ?>"/>
        ...
        <option value="OL">After Ordinary Level</option>
        <option value="AL">After Advanced Level</option>
    ...
    <img class="image" src="img/information-sign-png-5.png" height="12px" />
            ...
            <li><strong>This bio will be visible to others on your profile</strong></li>
              <li>Say where you are employeed.</li>
              <li>Say what are your future aspirations. </li>
              <li>State your claim to fame.</li>
              <li>Write better to promote yourself.</li>
            </ul>
            </span><br>
		    <textarea rows="10" cols="100" name="bio" id="bio" class="form-control"><?php echo $userdata['bio'];?></textarea>
     ...
     <div class="tab-pane fade" id="contact_details">
      <div class="panel panel-default">
       ...
       <span id="error_cat" class="text-danger"></span>
        ...
        <div class = "form-group">
					<input type="checkbox" id="category" name="category[]" value="technology"<?php if (!empty($_SESSION['categories'])) if (in_array("technology", $_SESSION['category'])) echo "checked='checked'"; ?>>Technology<br/>
					<input type="checkbox" id="category" name="category[]" value="Science"<?php if (!empty($_SESSION['category'])) if (in_array("Science", $_SESSION['category'])) echo "checked='checked'"; ?>>Science<br/>
        ...
        <div>
         ...
         <button type="button" name="btn_contact_details" id="btn_contact_details" class="btn btn-success btn-lg">Edit</button>
        </div>
        <br />
       </div>
      </div>
