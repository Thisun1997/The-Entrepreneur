...
<body>
  ...
  <div class="row">
      ...
      <div class="col-md-8">
        <div class="row">
            <a href="facilitatoredit.php?edit=<?php echo $userdata['email']; ?>" ><button id="update"><i class="fas fa-user-edit"></i>  Edit account</button></a>
        ...
        <div class="row">
          <div class="container tabs">
            ...
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#home">Posts I have commented</a></li>
              <li><a data-toggle="tab" href="#menu1">Posts I have set flags</a></li>
              <li><a data-toggle="tab" href="#menu2">Posts I have given offers</a></li>
            </ul>
