...
<?php $inventor = new Inventor();
$facilitator = new Facilitator();
  if($inventor->isLoggedIn()):
    include "inventorprofile.php"; 
  elseif($facilitator->isLoggedIn()):
    include "facilitatorprofile.php"; 
  else:
?>
  ...
  <body>    
    ...
    <section id="hero" class="text-white tm-font-big tm-parallax">
        ...
        <div class="container">   
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                  <a class="nav-link tm-nav-link" href="#work">ABOUT US</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link tm-nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">CATEGORIES</a>

              <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <a class="dropdown-item" href="#">Art & Humanities</a>
                  <a class="dropdown-item" href="#">Bussiness & Manegement</a>
                  <a class="dropdown-item" href="#">Accounting</a>
                  <a class="dropdown-item" href="#">Design & Fashion</a>
                  <a class="dropdown-item" href="#">Engineering</a>
                  <a class="dropdown-item" href="#">IT</a>
                  <a class="dropdown-item" href="#">Marketing & Sales</a>
              ...
              <li class="nav-item">
                <a class="nav-link tm-nav-link" href="#register-login">LOGIN/REGISTER</a>
            </li>   
              <li class="nav-item">
      ...
      <div class="text-center tm-hero-text-container">
        <div class="tm-hero-text-container-inner">
            <h2 class="tm-hero-title">Welcome to the Entrepreneur</h2>
    ...
    <section id="introduction" class="tm-section-pad-top">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <img src="img/111.jpg" alt="Image" class="img-fluid tm-intro-img" />
          </div>
          <div class="col-lg-6">
    ...
    <!--Login/Register-->
    <!--Register-->
    <section id = "register-login" class="row">
    <div class="column">
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form method="post" action="" class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input" data-validate="Name is required">
            ...
            <input class="input100" type="text" name="firstname" value="<?php echo escape(Input::get('firstname')); ?>">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
            <span class="label-input100">Last name</span>
            <input class="input100" type="text" name="lastname" value="<?php echo escape(Input::get('lastname')); ?>">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate="Username is required">
            <span class="label-input100">Email</span>
            <input class="input100" type="text" name="email" value="<?php echo escape(Input::get('email')); ?>">
            <span class="focus-input100"></span>
          </div>
          ...
          <div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
            ...
            <input class="input100" id="password-field2" type="password" name="password_2">
            <span class="focus-input100"></span>
            <span toggle="#password-field2" class="fa fa-fw fa-eye-slash field-icon toggle-password"></span>
          </div>

          <div class="contact100-form-checkbox">
          <input type="radio" name="type" value="facilitator" class="btn" <?php if(isset($_POST['type']) && $_POST['type'] == 'facilitator')  echo ' checked="checked"';?>/> Facilitator
          </div>

          <div class="contact100-form-checkbox">
          <input type="radio" name="type" value="inventor" class="btn" <?php if(isset($_POST['type']) && $_POST['type'] == 'inventor')  echo ' checked="checked"';?>/> Inventor
			      <br>
          </div>

          <div class="flex-m w-full p-b-33">
            <div class="contact100-form-checkbox">
              <input type="checkbox" name="check" <?php if(isset($_POST['check']))  echo ' checked="checked"';?>/>
          ...
          <div class="container-login100-form-btn">
              <button type="submit" name="register" class="btnreglog">Register</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="column">
      <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
        <form method="post" action="" class="login100-form validate-form">
          ...
          <div class="wrap-input100 validate-input" data-validate="Name is required">
            <span class="label-input100">Email</span>
            <input class="input100" type="text" name="emaillog" value="<?php echo escape(Input::get('emaillog')); ?>">
            <span class="focus-input100"></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
            <span class="label-input100">Password</span>
            <input class="input100" id="password-field3" type="password" name="password">
            <span class="focus-input100"></span>
            <span toggle="#password-field3" class="fa fa-fw fa-eye-slash field-icon toggle-password"></span>
          </div>

          <div class="container-login100-form-btn">
          <button type="submit" name="login" class="btnreglog">Login</button>
          </div>
