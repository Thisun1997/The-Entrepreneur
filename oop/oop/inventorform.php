...
$user = new Inventor();
if ((Session::exists('user')) && (!$user->isLoggedIn())) : 
  ...
  <div class="container-fluid" id="section1">
    <div class="container">
      <div class="row">
        ...
        <h3> You are only few step away from being a Inventor. </h3>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="panel panel-default">
       ...
       <div class="panel-body">
        ...
        <div class="form-group">
         ...
         <input type="text" name="firstname" id="first_name" class="form-control" value="<?php echo escape($user->data()->firstname); ?>" readonly="readonly" />
         <span id="error_first_name" class="text-danger"></span>
        </div>
        <div class="form-group">
         <label>Enter Last Name</label>
         <input type="text" name="lastname" id="last_name" class="form-control" value="<?php echo escape($user->data()->lastname); ?>" readonly="readonly"/>
         <span id="error_last_name" class="text-danger"></span>
        </div>
         <label>Email Address</label>
         <input type="text" name="email" id="email" class="form-control" value="<?php echo escape($user->data()->email); ?>" readonly="readonly"/>
