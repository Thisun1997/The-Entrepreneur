        ...
        $education = $_POST['education'];
 		...
 		//if (count($errors) == 0) {
			...
			$newvalues = implode(",",$category);
  			$query = "INSERT INTO inventor (firstname, lastname, email, `phone-number`,address,gender,`Educational Level`,DoB,bio,categories) Values ('$firstname', '$lastname', '$email', '$phone','$address','$gender','$education','$dob','$bio','$newvalues')";
        echo $query;
